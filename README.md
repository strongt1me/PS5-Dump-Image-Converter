...
![Version](https://img.shields.io/badge/Version-v1.8.50-blue)
...
| Windows-EXE-Ziel | `dist\PS5_Dump_Image_Converter_v1.8.50.exe` |
...
Die Aufgabenbezeichnungen entsprechen der aktuellen Oberfläche von v1.8.50.
...
2. `PS5_Dump_Image_Converter_v1.8.50.exe` starten.
...
```text
dist\PS5_Dump_Image_Converter_v1.8.50.exe
```
...
```text
dist/PS5_Dump_Image_Converter_v1.8.50_linux_x86_64
```
...
Die PyInstaller-Spezifikation erzeugt den synchronisierten v1.8.50-Zielnamen. PyInstaller bündelt die Python-Anwendung für Windows.[6]
...
| `BENUTZERHANDBUCH.html` | Bedienanleitung zum Lesen im Browser (v1.8.50, mit Inhaltsverzeichnis, alle Aufgaben und Werkzeugleisten-Buttons) |
